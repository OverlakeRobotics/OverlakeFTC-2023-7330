...
public class GamePositions {
    ...
    public static final Pose2d BLUE_BACKDROP_CENTER = new Pose2d(49, 32.5, Math.toRadians(-180));
    public static final Pose2d BLUE_BACKDROP_RIGHT = new Pose2d(49, 24, Math.toRadians(-180));
...
//    public static final Pose2d BLUE_OBJECT_POS_4_3 = new Pose2d(-40, 37, Math.toRadians(-30));
    ...
    public static final Pose2d BLUE_WAYPOINT_1 = new Pose2d(-35, 12, Math.toRadians(180));
