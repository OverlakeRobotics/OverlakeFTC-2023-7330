...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 15.32; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -5.27; // in; offset of the lateral wheel
